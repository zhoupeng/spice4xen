...
#install: install-tools install-xen install-kernels install-stubdom install-docs
...
#dist: dist-tools dist-xen dist-kernels dist-stubdom dist-docs
#dist: dist-xen dist-kernels install-tools dist-stubdom dist-docs
