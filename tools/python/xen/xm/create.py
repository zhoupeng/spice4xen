...
gopts.var('spice', val='',
          fn=set_value, default=None,
          use="""Should the device model use Spice?""")

gopts.var('spicehost', val='',
          fn=set_value, default=None,
          use="""Host interface to use for spice""")

gopts.var('spiceport', val='',
          fn=set_value, default=None,
          use="""port to use for spice""")

gopts.var('spicepasswd', val='',
          fn=set_value, default=None,
          use="""password for spice, if disable_ticketing is set false""")

gopts.var('spice_disable_ticketing', val='',
          fn=set_value, default=None,
          use="""Should disable spice ticketing?""")

gopts.var('spiceic', val='',
          fn=set_value, default=None,
          use="""Spice image compression""")

gopts.var('spicesv', val='',
          fn=set_value, default=None,
          use="""Spice video streams detection and compression""")

gopts.var('spicejpeg_wan_compression', val='',
          fn=set_value, default=None,
          use="""spice jpeg wan compression""")

gopts.var('spicezlib_glz_wan_compression', val='',
          fn=set_value, default=None,
          use="""spice zlib_glz wan compressio""")

gopts.var('spiceplayback', val='',
          fn=set_value, default=None,
          use="""spice playback compression""")

gopts.var('spiceagent_mouse', val='',
          fn=set_value, default=None,
          use="""spice agent mouse mode""")

gopts.var('qxl', val='',
          fn=set_value, default=None,
          use="""Should the device model use qxl?""")

gopts.var('qxlnum', val='',
          fn=set_value, default=None,
          use="""qxl num""")

gopts.var('qxlram', val='',
          fn=set_value, default=None,
          use="""qxl ram""")
...
def configure_hvm(config_image, vals):
    ...
    args = [ 'acpi', 'apic',
             ...
             'spice', 'spicehost', 'spiceport', 'spicepasswd', 'spice_disable_ticketing',
             'spiceic', 'spicesv', 'spicejpeg_wan_compression', 'spicezlib_glz_wan_compression',
             'spiceplayback', 'spiceagent_mouse',
             'qxl', 'qxlnum', 'qxlram',
